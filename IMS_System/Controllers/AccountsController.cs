...
//        public AccountsController(ImsSystemContext context, INotyfService notifyService)
//        {
//            _context = context;
...
//        [AllowAnonymous]
//        [Route("Login.html", Name = "Login")]
//        public async Task<IActionResult> Login(User _user, string returnUrl = null)
//        {
//            if (ModelState.IsValid)
//            {
//                if (isEmail(_user.Email))
//                {
...
//                            .Include(u => u.Role)
//                            .SingleOrDefault(s => (s.Email.Equals(_user.Email) || s.Mobile.Equals(_user.Email)) && s.Password.Equals(_user.Password));
//                        if (user != null)
//                        {
//                            //add session
